...
void Compare3PlotsWaveform()
{
	...
	{ 
		for(int i = 0; i <= 2; i++)
		{
			...
			MakePlot(i,angles[k],angles[k+1],(char*)"data",(char*)"X",0,(char*)"./Results/data/UWireBias1",(char*)"UWireBias1",(char*)"X",0,(char*)"./Results/data/UWireBias2",(char*)"UWireBias2",(char*)"X",0,(char*)"./Results/data/WireBiasNominal",(char*)"WireBiasNominal",(char*)"UWireBiasStudy");
		}
	}
...
void MakePlot(int planenum, int angle_low, int angle_high, char* runformat, char* runtype1, int binnum1, char* filepath1, char* label1, char* runtype2, int binnum2, char* filepath2, char* label2, char* runtype3, int binnum3, char* filepath3, char* label3, char* savefiletext)
{
	...
	WaveformHist1->SetTitle(Form("U-Plane Wire Bias Study, Plane %d: Average Waveform @ Anode",planenum));
	...
	leg->AddEntry(WaveformHist1, "U-Plane = -220V","L");
	leg->AddEntry(WaveformHist2, "U-Plane = -180V","L");
	leg->AddEntry(WaveformHist3, "U-Plane = -212.32V", "L");
	leg->Draw("SAME");
